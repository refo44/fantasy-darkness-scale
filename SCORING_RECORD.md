...
Full per-work analysis for every title rescored under the v2 methodology so far. Criteria are
scored 0-4 (see `CRITERIA_THEORY.md` for what each one is a construct of and
`Fantasy_Grimdark_Scale_v2_WIP.xlsx`'s Methodology sheet for the literal 0-4 anchors).
`Final Score = 1.5 + Weighted Internal Score × 2.25`, `Tier = FLOOR(Final Score)`.

Where a work was rescored after initial review (a correction was made mid-discussion), only
the final, corrected scoring is recorded here.

---

## My Neighbor Totoro

* Structural Despair: 0 — no world condemned to anything; everyday kindness is simply how the world works.
* Limited Heroism: 0 — no antagonist or structure to overcome; small acts fully resolve the story.
* Moral Cynicism: 0 — kindness is consistently, uncomplicatedly rewarded.
* Structural Corruption: 0 — no institutions shown at all.
* Redemption Difficulty: 0 — nobody needs redemption.
* Narrative Acceptance of Injustice: 0 — no injustice depicted.
* Explicit Darkness: 0 — no real danger; the mother's illness is handled entirely off-page and gently.
...
* Limited Heroism: 0
* Moral Cynicism: 0
* Structural Corruption: 0 — the low-stakes "protection racket" subplot resolves peacefully.
* Redemption Difficulty: 0
* Narrative Acceptance of Injustice: 0
* Explicit Darkness: 0 — extremely low-conflict cozy fantasy throughout.
...
* Structural Despair: 0 — the ending is durably optimistic for Marsyas Island.
* Limited Heroism: 0 — Linus's actions genuinely, lastingly change the island's fate.
* Moral Cynicism: 0 — kindness wins clearly.
* Structural Corruption: 1 — DICOMY's institutional prejudice is real, framed as something actively being challenged.
* Redemption Difficulty: 0 — Linus's growth doesn't require major sacrifice.
* Narrative Acceptance of Injustice: 0 — injustice is framed optimistically as something to overcome.
* Explicit Darkness: 0 — no violence.

Weighted = 0.3 → Final Score = 2.175 → **Tier 2**

## Harry Potter and the Philosopher's Stone

* Structural Despair: 0 — the wizarding world is fundamentally fine.
* Limited Heroism: 0 — Harry definitively stops Quirrell/Voldemort this book.
* Moral Cynicism: 0 — good triumphs clearly.
* Structural Corruption: 1 — minor institutional-flaw hints at Hogwarts/Ministry.
* Redemption Difficulty: 0
* Narrative Acceptance of Injustice: 0
* Explicit Darkness: 1 — the troll and brief real danger, handled for a children's audience.

Weighted = 0.4 → Final Score = 2.4 → **Tier 2**

## The Lord of the Rings

* Structural Despair: 2 — the "long defeat," fading magic, and Elves leaving Middle-earth are real and permanent, balanced against real triumph.
* Limited Heroism: 1 — Sauron is durably defeated, a genuine structural victory.
* Moral Cynicism: 0 — virtue is consistently rewarded in Tolkien's framework.
* Structural Corruption: 1 — Isengard and Théoden's briefly-corrupted court, both puntual/corrigible.
* Redemption Difficulty: 2 — Boromir and Gollum both show real cost to redemption (or failure to achieve it).
* Narrative Acceptance of Injustice: 0 — the central injustice (Sauron's threat) is fully resolved.
* Explicit Darkness: 2 — real war and death, orcs, but not graphic.

Weighted = 1.1 → Final Score = 3.975 → **Tier 3**

## Frieren: Beyond Journey's End

* Structural Despair: 2 — mortality and the passage of time are unresolvable, central themes.
* Limited Heroism: 1 — the Demon King's threat is durably ended.
* Moral Cynicism: 0
* Structural Corruption: 0 — no corrupt institutions central to the plot.
* Redemption Difficulty: 1
* Narrative Acceptance of Injustice: 2 — mortality itself is accepted as permanent and unresolvable; the story's emotional core is finding meaning despite that, not overcoming it.
* Explicit Darkness: 2 — real battle violence and demons, not graphic.

Weighted = 1.1 → Final Score = 3.975 → **Tier 3**

## Discworld

* Structural Despair: 1 — Ankh-Morpork genuinely improves across the series under Vetinari; the trend is upward.
* Limited Heroism: 1 — Vimes/Vetinari's efforts durably improve the city across books.
* Moral Cynicism: 1 — satire punctures both cynicism and idealism, but decency ultimately wins.
* Structural Corruption: 1 — flawed but genuinely reformed institutions over the series.
* Redemption Difficulty: 1
* Narrative Acceptance of Injustice: 1
* Explicit Darkness: 1 — mostly comedic violence, low graphic content.

Weighted = 1.0 → Final Score = 3.75 → **Tier 3**

## Fullmetal Alchemist: Brotherhood

* Structural Despair: 1 — Amestris genuinely improves; the worst elements of the state are overthrown by the end.
* Limited Heroism: 1 — Ed/Al's actions durably fix the core problem (homunculi defeated, truth restored).
* Moral Cynicism: 1
* Structural Corruption: 2 — the military government is genuinely deeply corrupt/manipulated by the homunculi at the outset.
* Redemption Difficulty: 2 — Scar, Mustang, and others have real redemption arcs with genuine cost.
* Narrative Acceptance of Injustice: 1
* Explicit Darkness: 3 — human transmutation body horror, genocide backstory, on-page violence.
...
* Structural Despair: 3 — this version is notably bleaker than Brotherhood; it doesn't resolve as hopefully.
* Limited Heroism: 2
* Moral Cynicism: 2
...
Weighted = 2.25 → Final Score = 6.5625 → **Tier 6**

## The Witcher

* Structural Despair: 2
* Limited Heroism: 2
* Moral Cynicism: 2 — Geralt's pragmatic neutrality; political brutality is common but not universally rewarded.
* Structural Corruption: 2
* Redemption Difficulty: 2
* Narrative Acceptance of Injustice: 2
* Explicit Darkness: 3

Weighted = 2.1 → Final Score = 6.225 → **Tier 6**
...
* Redemption Difficulty: 1
* Narrative Acceptance of Injustice: 2
* Explicit Darkness: 4 — specifically known for extreme, disturbing explicit content.

Weighted = 1.9 → Final Score = 5.775 → **Tier 5**
...
* Structural Despair: 2
* Limited Heroism: 2
* Moral Cynicism: 3 — nihilistic total war, an explicitly amoral protagonist.
* Structural Corruption: 2
* Redemption Difficulty: 2
* Narrative Acceptance of Injustice: 2
* Explicit Darkness: 3
...
* Structural Despair: 3 — war and political chaos recur generation after generation; any peace is fragile and collapses.
* Limited Heroism: 3 — Ned, Robb, and Jon all die or fail trying to change the system; the "game" continues regardless of who's virtuous.
* Moral Cynicism: 3 — "chaos is a ladder"; honor is systematically punished.
* Structural Corruption: 3 — the Iron Throne, the Faith, and the Great Houses are all deeply compromised.
* Redemption Difficulty: 3 — Jaime's arc takes books; Cersei never redeems at all.
* Narrative Acceptance of Injustice: 3 — slavery and exploitation of the smallfolk are treated as structural and persistent, not obstacles that get overcome.
* Explicit Darkness: 4 — the Red Wedding, explicit torture, sexual violence — central and recurring, not incidental.

Weighted = 3.1 → Final Score = 8.475 → **Tier 8**

(Corrected after review — an initial pass under-scored several axes at 2; see `ADDITIONS_LOG.md` for the comparison discussion.)
...
* Structural Despair: 4 — the ending is famous for reinforcing that nothing really gets better; corrupt systems persist unchanged.
* Limited Heroism: 4 — the protagonists' efforts largely fail to change anything meaningful by the trilogy's end.
* Moral Cynicism: 4 — literally every honorable impulse in the series gets punished or corrupted.
* Structural Corruption: 4 — the Union's government and the Inquisition (a torture apparatus) are corrupt to the core.
* Redemption Difficulty: 3 — Glokta arguably never truly redeems, just continues being what he is.
* Narrative Acceptance of Injustice: 3 — the bleak ending treats injustice as structural and persistent.
* Explicit Darkness: 4

Weighted = 3.7 → Final Score = 9.825 → **Tier 9**

(Corrected after review — an initial pass under-scored several axes at 3, which would have
left tier 9 with zero occupants; see `ADDITIONS_LOG.md`.)
...
* Limited Heroism: 2
* Moral Cynicism: 2
* Structural Corruption: 3 — systematic genocide cover-up, deeply embedded.
* Redemption Difficulty: 2
* Narrative Acceptance of Injustice: 2
* Explicit Darkness: 2

Weighted = 2.15 → Final Score = 6.3375 → **Tier 6**

Flagged as genuinely ambiguous, not a clear error: the plot centers on systematic
institutionalized child-killing and genocide, which arguably deserves higher scores than
this on several axes — but unlike Dark Souls, there's no directly comparable sibling work to
prove the inconsistency against. Left as-is at the user's request.
...
* Structural Despair: 2
* Limited Heroism: 1 — player actions genuinely resolve the dragon crisis and can resolve the civil war.
* Moral Cynicism: 2 — political factions act from real self-interest.
* Structural Corruption: 2 — the Thalmor, corrupt politics.
* Redemption Difficulty: 1
* Narrative Acceptance of Injustice: 2 — Thalmor oppression and racial tension between Nords/Elves.
* Explicit Darkness: 2
...
* Limited Heroism: 2
* Moral Cynicism: 2
* Structural Corruption: 3 — the Organization treats its warriors as disposable tools.
* Redemption Difficulty: 2
* Narrative Acceptance of Injustice: 2
* Explicit Darkness: 3 — graphic monster violence, body horror of "awakened" beings.

Weighted = 2.25 → Final Score = 6.5625 → **Tier 6**

## Made in Abyss

* Structural Despair: 2 — the Abyss's curse is a fixed, unresolvable natural law.
* Limited Heroism: 2
* Moral Cynicism: 2
* Structural Corruption: 2 — adults sending children into the Abyss to their doom.
* Redemption Difficulty: 2
* Narrative Acceptance of Injustice: 2
* Explicit Darkness: 4 — notorious specifically for graphic body horror and child endangerment beneath a deceptively cute art style.

Weighted = 2.2 → Final Score = 6.45 → **Tier 6**
...
* Limited Heroism: 2
* Moral Cynicism: 2
* Structural Corruption: 3 — Bearer slavery is a deeply embedded societal institution.
* Redemption Difficulty: 2
* Narrative Acceptance of Injustice: 2 — slavery/oppression is a central, persistent theme.
* Explicit Darkness: 3 — very graphic combat and war violence, notably mature for the franchise.

Weighted = 2.25 → Final Score = 6.5625 → **Tier 6**

## Elden Ring

* Structural Despair: 4 — the Lands Between are explicitly shattered and decaying.
* Limited Heroism: 3
* Moral Cynicism: 3
* Structural Corruption: 3
* Redemption Difficulty: 3
* Narrative Acceptance of Injustice: 3
* Explicit Darkness: 3

Weighted = 3.15 → Final Score = 8.5875 → **Tier 8**

## Fire Punch

* Structural Despair: 3
* Limited Heroism: 3
* Moral Cynicism: 4 — a notoriously amoral, exploitative world.
* Structural Corruption: 3
* Redemption Difficulty: 3
* Narrative Acceptance of Injustice: 3
* Explicit Darkness: 4 — one of the more disturbing works in the catalog.

Weighted = 3.25 → Final Score = 8.8125 → **Tier 8**
...
* Structural Despair: 1 — real political danger and imprisonment, but ultimately overcome.
* Limited Heroism: 0 — the protagonist's cleverness genuinely resolves the crisis.
* Moral Cynicism: 1 — political self-interest is real but not dominant.
* Structural Corruption: 1 — witchcraft accusations show institutional injustice, but it's temporary.
* Redemption Difficulty: 0
* Narrative Acceptance of Injustice: 0 — injustice depicted but treated as solvable.
* Explicit Darkness: 1 — imprisonment and threat of execution, not graphic.

Weighted = 0.55 → Final Score = 2.7375 → **Tier 2**

## Avatar: The Last Airbender

* Structural Despair: 2 — the genocide of the Air Nomads already happened and is permanent, regardless of the show's hopeful ending.
* Limited Heroism: 1 — Aang's actions genuinely end the war and restore balance — meaningful lasting change.
* Moral Cynicism: 1 — mostly a world where good triumphs, though Fire Nation atrocities show real cynicism exists.
* Structural Corruption: 1 — Fire Nation imperialism and corrupt officials, ultimately resolved.
* Redemption Difficulty: 2 — Zuko's redemption arc is genuinely difficult and takes the whole series.
* Narrative Acceptance of Injustice: 1 — colonialism/oppression is real but actively fought and largely resolved.
* Explicit Darkness: 2 — a genocide backstory and real war violence, though not depicted graphically for its audience.

Weighted = 1.4 → Final Score = 4.65 → **Tier 4**

Notable: this is the Methodology's own textbook example of Hopepunk tag ≠ low darkness (Avatar
is tagged Hopepunk but depicts real war and genocide). The tag never entered the score — this
result is the methodology correctly separating tone from content.

## Mushishi

* Structural Despair: 1 — bittersweet and contemplative; many episodes end tragically, but the world itself keeps functioning.
* Limited Heroism: 1 — Ginko's interventions help individuals but don't change the broader Mushi phenomenon.
* Moral Cynicism: 0
* Structural Corruption: 0 — no real institutions.
* Redemption Difficulty: 1
* Narrative Acceptance of Injustice: 1 — some episodes deal with irreversible loss accepted as part of life.
* Explicit Darkness: 1 — unsettling/eerie content, but low-key.

Weighted = 0.7 → Final Score = 3.075 → **Tier 3**

## A Choir of Lies

* Structural Despair: 1 — the flower-market bubble causes real financial ruin, but it's an isolated crisis, not a structural world condition.
* Limited Heroism: 0 — the protagonist's reckoning genuinely resolves the central conflict.
* Moral Cynicism: 1 — the market manipulation briefly rewards deception before consequences catch up.
* Structural Corruption: 1 — elite economic exploitation of ordinary people, same register as the prequel.
* Redemption Difficulty: 1 — the protagonist orchestrated real harm to real people and has to genuinely reckon with that guilt, more than the prequel's protagonist did.
* Narrative Acceptance of Injustice: 0 — the harm caused is treated as something to atone for, not permanent.
* Explicit Darkness: 1 — grief and financial ruin, no violence.

Weighted = 0.7 → Final Score = 3.075 → **Tier 3**

## The Chronicles of Narnia

* Structural Despair: 1 — the Hundred Years of Winter is real, but the whole arc is about ending it.
* Limited Heroism: 0 — the Pevensies (with Aslan) durably defeat the Witch and restore just rule for years.
* Moral Cynicism: 0 — goodness is rewarded about as consistently as a text can make it.
* Structural Corruption: 1 — the Witch's tyranny (secret police, turning dissenters to stone) is real, but it's the anomaly being overthrown.
* Redemption Difficulty: 1 — Edmund's redemption isn't free (Aslan dies for it), but Edmund himself doesn't do the work of it — someone else pays the cost.
* Narrative Acceptance of Injustice: 0 — the Witch's rule is explicitly temporary and overturned.
* Explicit Darkness: 2 — Aslan's death scene (shorn, muzzled, mocked, killed) is genuinely intense for children's literature, even without graphic detail.

Weighted = 0.65 → Final Score = 2.9625 → **Tier 2**

## Dungeons & Dragons: Honor Among Thieves

* Structural Despair: 0 — standard D&D adventure setting, nothing structurally despairing.
* Limited Heroism: 0 — the heist crew durably stops Sofina's death-magic plot and restores order.
* Moral Cynicism: 1 — Forge's betrayal of his friend is a real, stinging low point.
* Structural Corruption: 1 — Forge's corrupt rule as Lord of Neverwinter, treated as solvable.
* Redemption Difficulty: 0 — no real redemption arc requiring significant sacrifice.
* Narrative Acceptance of Injustice: 0 — both villains' schemes are fully undone.
* Explicit Darkness: 1 — Edgin's wife's death (off-screen, pre-story) and some combat, played mostly for adventure/comedy.

Weighted = 0.4 → Final Score = 2.4 → **Tier 2**

## Harry Potter and the Chamber of Secrets

* Structural Despair: 0 — the monster threat is fully resolved, no lasting structural damage.
* Limited Heroism: 0 — Harry destroys the Basilisk and the diary, a complete victory.
* Moral Cynicism: 0
* Structural Corruption: 1 — Lucius Malfoy's school-board influence, the Ministry's 50-year cover-up of the Chamber's first opening.
* Redemption Difficulty: 0
* Narrative Acceptance of Injustice: 1 — Dobby's abuse is resolved, but the broader blood-status prejudice is shown as real and left unaddressed.
* Explicit Darkness: 2 — petrified students, a giant monster, Ginny's near-fatal possession — noticeably scarier than book 1.

Weighted = 0.5 → Final Score = 2.625 → **Tier 2**

## The Hobbit

* Structural Despair: 1 — Smaug's tyranny is real but localized and time-limited, not a broader world condition.
* Limited Heroism: 1 — the quest succeeds, but Thorin's death undercuts a totally clean victory.
* Moral Cynicism: 0 — Thorin's gold-sickness is a personal flaw, not a systemic reward for greed.
* Structural Corruption: 1 — the Master of Lake-town's cowardice/corruption, present but minor.
* Redemption Difficulty: 2 — Thorin's reconciliation with Bilbo happens on his deathbed — real cost.
* Narrative Acceptance of Injustice: 0
* Explicit Darkness: 2 — the Battle of Five Armies, Smaug's destruction of Lake-town, real character deaths.

Weighted = 0.95 → Final Score = 3.6375 → **Tier 3**

## Castle in the Sky

* Structural Despair: 0 — clean adventure structure, no lingering world-level despair.
* Limited Heroism: 0 — Sheeta and Pazu permanently destroy Laputa's weapon capability and stop Muska.
* Moral Cynicism: 0
* Structural Corruption: 1 — Muska represents real military/government ambition to weaponize Laputa, fully foiled.
* Redemption Difficulty: 0 — Muska stays a clear villain; no one requires meaningful redemption.
* Narrative Acceptance of Injustice: 0
* Explicit Darkness: 2 — real peril (kidnapping, aerial gunfights, soldiers dying), genuine ruthlessness from Muska.

Weighted = 0.35 → Final Score = 2.2875 → **Tier 2**

## Spirited Away

* Structural Despair: 0 — the spirit world is strange but coherent, not despairing.
* Limited Heroism: 1 — Chihiro saves her parents and frees Haku, but Yubaba's bathhouse system carries on exactly as before.
* Moral Cynicism: 0 — her kindness is consistently what saves everyone.
* Structural Corruption: 2 — the bathhouse's labor system is genuinely exploitative; Yubaba steals names/identities as control.
* Redemption Difficulty: 1 — No-Face's corruption is resolved through straightforward kindness, not a costly sacrifice.
* Narrative Acceptance of Injustice: 1 — Chihiro escapes the system personally, but it isn't overturned.
* Explicit Darkness: 2 — her parents turning into pigs is genuine body horror; No-Face's feeding scenes carry real dread.

Weighted = 0.95 → Final Score = 3.6375 → **Tier 3**

## Final Fantasy III & V

* Structural Despair: 0 — classic JRPG structure; the heroes restore balance/prevent apocalypse cleanly.
* Limited Heroism: 0 — Xande's and Exdeath's plots are both fully, permanently stopped.
* Moral Cynicism: 0
* Structural Corruption: 0 — the threats are cosmic/magical, not societal.
* Redemption Difficulty: 0 — no significant morally-compromised character needing redemption.
* Narrative Acceptance of Injustice: 0
* Explicit Darkness: 3 — Galuf's on-page death plus near-constant combat matches "muerte explícita, con frecuencia" better than a lower score would.

Weighted = 0.3 → Final Score = 2.175 → **Tier 2**

(Corrected after review — an initial pass scored Explicit Darkness a 2, which produced an
implausible tier 1; see `ADDITIONS_LOG.md`.)

## Slayers

* Structural Despair: 0 — ancient evil threats get defeated within their arcs.
* Limited Heroism: 0 — Lina and company's victories are complete within each arc.
* Moral Cynicism: 0 — Lina's greed is a comedic flaw, not something the world rewards.
* Structural Corruption: 0 — episodic adventure structure, not institutional critique.
* Redemption Difficulty: 0
* Narrative Acceptance of Injustice: 0
* Explicit Darkness: 3 — city-leveling magical destruction and a recurring near-apocalyptic threat, applying the FF III & V lesson: comedic tone can mask genuinely high-stakes content.

Weighted = 0.3 → Final Score = 2.175 → **Tier 2**

## The Legend of Zelda

* Structural Despair: 1 — some entries (Breath of the Wild especially) depict Hyrule as genuinely fallen and ruined for a century.
* Limited Heroism: 1 — Link's victories are complete per-game, but the eternal reincarnation cycle means the threat is never truly ended at the franchise level.
* Moral Cynicism: 0 — the Triforce mythology rewards virtue cleanly.
* Structural Corruption: 1 — Ganon's tyranny is real when he seizes power, but Hyrule's monarchy is otherwise legitimate.
* Redemption Difficulty: 0 — Ganon is a recurring pure antagonist, not a redemption arc.
* Narrative Acceptance of Injustice: 0 — within any given game, tyranny is fully resolved.
* Explicit Darkness: 2 — real combat and genuinely unsettling imagery, but stays family-friendly/stylized rather than graphic.

Weighted = 0.65 → Final Score = 2.9625 → **Tier 2**

## The Little Prince

* Structural Despair: 1 — adults' collective loss of wonder/imagination reads as a mild, real form of spiritual stagnation, though it's not a "world in decline" in the usual sense.
* Limited Heroism: 0 — not really an action/heroism narrative; the "victory" here is emotional understanding, not structural change.
* Moral Cynicism: 1 — the various adults (the king, the businessman, the vain man) represent a gentle but real critique of how adult society rewards a kind of spiritual poverty.
* Structural Corruption: 0 — not institutional in nature.
* Redemption Difficulty: 0 — no redemption arc; it's a journey of understanding, not moral repair.
* Narrative Acceptance of Injustice: 0 — not framed around injustice.
* Explicit Darkness: 2 — the Prince's death (snake bite) is genuinely significant and carries real emotional weight, handled gently/allegorically rather than gratuitously, but it's a real, meaningful death, not just background peril.

Weighted = 0.5 → Final Score = 2.625 → **Tier 2**

Flagging this one as a genuine judgment call rather than a clean result: The Little Prince has
a real reputation for poignancy, and its ending is often cited as one of literature's more
touching. But unlike Spirited Away or The Hobbit, where darkness runs across several criteria
at once, this book concentrates almost all of its weight into a single beautiful, sad ending
